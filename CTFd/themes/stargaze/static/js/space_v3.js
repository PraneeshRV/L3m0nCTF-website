document.addEventListener('DOMContentLoaded', function () {
    ...
    let shootingStars = [];
    let constellations = [];
    const numStars = 150; // Reduced to 150 for a very sparse look
    ...
    function animate(timestamp) {
        ...
        stars.forEach(star => {
            ...
            star.x += (star.vx + (mouseX * 0.0005)) * speedFactor; // Very subtle movement
            star.y += (star.vy + (mouseY * 0.0005)) * speedFactor; // Very subtle movement
